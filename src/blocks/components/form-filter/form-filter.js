    ...
    formsFilter.forEach(formFilter => {
        ...
        if(filterSelects.length > 0) {
            ...
            if(dateSelects.length > 0) {
               dateSelects.forEach(dateSelect => {
                    if(!dateSelect.hasAttribute('data-initialized')) {
                        ...
                        dateSelect.setAttribute('data-initialized', 'true')
        ...
        if(filterLists.length > 0) {
                ...
                filterLists.forEach(filterList => {
                    ...
                    const trigger = filterList.querySelector('.form-filter__show')
            
                    if(filterListItems.length > 5 && !trigger) {
